...
import handleCouponCopy from './index.js';
const Copun = () => {
    useEffect(() => {
        handleCouponCopy()
     },[])
    return (
        ...
        {/* -------------0000------------- */}
        <div className='flex flex-col md:flex-row  bg-gradient-to-r max-w-96 gap-2 from-sky-300 to-cyan-50 p-8 md:p-4 relative'>
           <div>
           <h3 className='text-2xl font-bold text-center uppercase'>Discount <br /> <span className="bg-gradient-to-r from-red-600  to-white bg-clip-text text-transparent ml-6">Coupon</span></h3>
            <div className='flex justify-center items-center gap-4'>
                ...
                <p className='text-2xl font-serif text-[#fff] w-14 bg-[#000000] rounded-full p-3'>G</p>
            </div>
           </div>
           <div className='flex justify-center items-center'>
            <p className='couponCode bg-[#fff] text-gray-400 p-1 font-semibold border-dotted border-2 border-r-0'>NewYear2024</p>
            <p className='couponBtn h-9  flex items-center  p-1 text-sm border-dotted border-2 border-l-dashed '>copy code</p>
           </div>
